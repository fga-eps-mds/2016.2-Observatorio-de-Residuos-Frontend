describe('mapCtrl', function() {
  ...
  it('Should get the map', function() {
    ...
    var contentMarkingFormatted = { name: 'INCIDENTE', description: 'Com acentuação.', latitude: -16.079271, longitude: -47.988983, author_name: undefined, author_email: undefined, likes: 0, dislikes: 0};
    ...
    var contentPEVFormatted = { name: 'PEV', description: 'PEV', author_name: undefined, author_email: undefined, latitude: -16.079239, longitude: -47.989033, paper: true, metal: false, plastic: true, glass: true, likes: 0, dislikes: 0};
      spyOn(NgMap, 'getMap').and.callThrough();
