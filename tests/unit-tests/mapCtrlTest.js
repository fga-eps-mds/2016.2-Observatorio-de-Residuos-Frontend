describe('mapCtrl', function() {
  ...
  it('Should get the map', function() {
    ...
    var contentMarkingFormatted = { name: 'INCIDENTE', description: 'Com acentuação.', latitude: -16.079271, longitude: -47.988983, id_marking_type: 12, author_name: undefined, author_email: undefined };
